...
public class ServicesObjectProxy implements ServiceInterface {
    ...
    @Override
    public Iterable<Child> getAllPlayers() throws Exception {
    ...
    public void addPoint(Child player, String time, Integer point) throws Exception {
        sendRequest(new PointsRequest(player,time,point));
    ...
    private void handleUpdate(UpdateResponse update){
        ...
        if (update instanceof PointsResponse){
            ...
            Child player =((PointsResponse) update).getPlayer();
            Integer point = ((PointsResponse) update).getPoint();
            String time= ((PointsResponse) update).getTime();
            System.out.println("Some points were added");
            try{
                client.addPoint(player,time,point);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
